<div id="page-wrapper">
	<div class="container-fluid">
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">List Course Teaching</h1>
			</div>
		</div>
		<div class="row">
			<div class="col-lg-12">
				<a href="index.php?page=lAddCourseTeaching" class="btn btn-success">Add Course Teaching</a>
				<br>
			</div>
		</div>
		<br>
				...
				<div class="table-responsive">
					<table class="table table-striped table-bordered table-hover">
						...
						while($row = mysql_fetch_array($result)){
							...
							echo '<td>
									<a href="index.php?page=lViewCourseTeaching&id='.$row['course_lecturer_ID'].'" class="btn btn-primary">View</a>
									<button class="btn btn-danger" 
									onclick="if(confirm(\'Are you sure to delete this course teaching?\')) 
												window.location.href=\'index.php?page=lDeleteCourseTeaching&id='.$row['course_lecturer_ID'].'\'">
									Delete</button>
									</td>';
							echo "</tr>";
							$i++;
